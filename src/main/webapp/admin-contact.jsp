...
<head>
    ...
    <style>
        ...
        h1 { margin: 0 0 8px; }
        p { margin: 0 0 14px; color: #667976; }
        .field { margin-bottom: 10px; }
        label { display: block; margin-bottom: 5px; font-size: 0.86rem; font-weight: 700; }
        input, select, textarea {
            width: 100%; border: 1px solid #d1dbd5; border-radius: 10px; padding: 10px; font: inherit; background: #fff;
        }
        textarea { min-height: 120px; resize: vertical; }
        .btn {
            width: 100%; border: 0; border-radius: 10px; padding: 10px; font: inherit; font-weight: 700;
            background: #0d6c63; color: #fff; cursor: pointer;
        }
